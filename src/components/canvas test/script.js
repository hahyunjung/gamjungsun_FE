document.addEventListener("DOMContentLoaded", function () {
  ...
  function placeRandomStars() {
    ...
    for (let i = 0; i < numStars; i++) {
      let x = (Math.random() * canvas.offsetWidth); //+ container.offsetWidth * 0.05;
      let y = (Math.random() * canvas.offsetHeight); //+ container.offsetHeight * 0.1;
      console.log(x, y)
